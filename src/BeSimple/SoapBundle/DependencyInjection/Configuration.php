...
class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('BeSimpleSoapBundle');
        $rootNode = $treeBuilder->getRootNode('be_simple_soap');
        ...
        $rootNode->children()
            ...
            ->defaultValue('BeSimpleSoapBundle:SoapWebService:exception')
            ->end()
            ->end();
                    ...
                    ->useAttributeAsKey('name')
                        ->prototype('array')
                            ->children()
                                ...
                                ->scalarNode('attachment_type')->end()
                                    ...
                                    ->children()
                                        ->scalarNode('type')
                                            ...
                                            ->validate()
                                                ...
                                                ->thenInvalid(sprintf('The auth type has to be either: %s', implode(', ', $this->proxyAuth)))
                                            ->end()
                                        ->end()
